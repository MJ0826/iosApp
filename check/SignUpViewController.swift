    ...
    @IBAction func signupTapped(sender: AnyObject) {
        ...
        if ( username.isEqualToString("") || password.isEqualToString("") ) {
          ...
          //  NSLog("PostData: %@",post);
            ...
            var url:String = "http://192.168.1.143:3000?username=\(username)&password=\(password)&c_password=\(confirm_password)"
            
            //url = "http://ip.jsontest.com/"
            url = "http://demoprojectserver1234.appspot.com/"
            
            let parameters = ["data" : "{\"username\":\"\(username)\",\"password\":\"\(password)\",\"c_password\":\"\(confirm_password)\"}"]
            ...
            manager.GET( url,
                ...
                success: { (operation: AFHTTPRequestOperation!,responseObject: AnyObject!) in
                    ...
                    //var loginObj = dic.objectForKey("data") as NSDictionary;
